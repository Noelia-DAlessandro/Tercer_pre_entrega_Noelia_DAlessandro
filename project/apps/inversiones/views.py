...
def lista_tipos_inversor(request):
    ...
    return render(request, 'inversiones/lista_tipos_inversor.html', {'tipos_inversor': tipos_inversor})


def lista_instrumentos_financieros(request):
    instrumentos_financieros = InstrumentoFinanciero.objects.all()
    return render(request, 'inversiones/lista_instrumentos_financieros.html', {'instrumentos_financieros': instrumentos_financieros})